...
df_mock_data.drop("half_age", axis=1)
print("\n", df_mock_data)
...
# DataFrame. 
combined_df = pd.concat([df_mock_data, df_new], ignore_index = True)
print(combined_df, '\n')
...
combined_df.loc[new_max_index] = new_values
print(combined_df)
